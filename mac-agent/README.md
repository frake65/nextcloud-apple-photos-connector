...
Die Option `retransferMissing` lässt den Server prüfen, ob eine bereits zugeordnete Datei am gespeicherten Pfad fehlt, und dafür erneut einen Upload anfordern. Standardmäßig ist sie ausgeschaltet. Sie ist keine Inhaltsprüfung aller bereits importierten Dateien.
